...
<head>
    ...
    <!-- Favicon icon -->
      <link rel="icon" type="image/png" sizes="32x32" href="C:/xampp/htdocs/projet/icon/222.png">
    <!-- Custom CSS -->
...
<body>
                    ...
                    <ul class="navbar-nav ms-auto d-flex align-items-center">
                        ...
                        <li>
                            <a class="profile-pic" href="#">
                                <img src="C:/xampp/htdocs/projet/icon/222.png" alt="user-img" width="50"
  ...
  <path fill-rule="evenodd" d="M7.293 1.5a1 1 0 0 1 1.414 0l6.647 6.646a.5.5 0 0 1-.708.708L8 2.207 1.354 8.854a.5.5 0 1 1-.708-.708L7.293 1.5z"/>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="http://localhost/reponse/afficherreponse.php"
                                aria-expanded="false">
            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Gestion des reclamation</h4>
                    </div>
  ...
  <div class="container">
<button  type ="submit" class="btn btn-primary my-5"><a href="ajouterreclamation.php"  class="text-light"> Ajouter un reclamation</a> </button>
 <!-- =======================PHP======================================= -->
		...
		<table class="table">
			...
			<td><?php
                echo'  
			<button class="btn btn-info"><a href="modifierreclamation.php? deletevar='.$reclamationC['id_rec'].'" class="text-light">Modifier </a></button>
  <button class="btn btn-danger"><a href="supprimerreclamation.php? deletevar='.$reclamationC['id_rec'].'" class="text-light">Delete</a></button>
		</td>';
				?>
                </td>
			</tr>
