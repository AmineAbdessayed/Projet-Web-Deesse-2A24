            ...
            <div class="container">
              ...
              <?php
                 ...
                 ?>
                    <div class="row">
                            <div class="col-md-6">
                            <!-- ?php echo'<img src="./assets/images/'.$sponsors['image_sp'].'" alt="image" class="img-fluid">'  ?> -->
                            ...
                            <div class="col-md-6">
                                <div class="details">
                                    <h2>Name:<?php echo $sponsors['name_sp']; ?></h2>
                                    
                                    <h4>Type:<?php echo $sponsors['type_sp']; ?></h4>
                                    <h4>Number:<?php echo $sponsors['numtel_sp']; ?></h4>
                                    <h4>Mail:<?php echo $sponsors['mail_sp']; ?></h4>
                                    <h4>Investissement:<?php echo $sponsors['inves_sp']; ?></h4>
                                    <h4>Description:<?php echo $sponsors['descrip_sp']; ?></h4>
