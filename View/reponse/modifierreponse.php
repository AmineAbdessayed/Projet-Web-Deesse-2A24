                    ...
                    <ul class="navbar-nav ms-auto d-flex align-items-center">
                        ...
                        <li>
                            <a class="profile-pic" href="#">
                                <img src="C:/xamppp/htdocs/reponse/icon/222.png" alt="user-img" wid_repth="50"
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <div class="d-md-flex">
                            ...
                            <a href="https://www.wrappixel.com/templates/ampleadmin/" target="_blank"
                                class="btn btn-danger  d-none d-md-block pull-right ms-3 hid_repden-xs hid_repden-sm waves-effect waves-light text-white">front
                                </a>
                        </div>
                    </div>
                </div>
...
<div class="row">
				...
				<div class="col-xs-12 col-sm-12 col-md-12 wow bounceIn animated" data-wow-delay=".1s">
					...
					<div class="col-xs-12 col-sm-6 col-md-6 form-group wow fadeInUp animated">
								...
								<input type="identifiant" placeholder="number" name="id_rep" class="form-control" id="id_rep" required="">
							</div>
