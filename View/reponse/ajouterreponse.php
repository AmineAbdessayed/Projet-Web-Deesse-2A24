...
include_once "$_SERVER[DOCUMENT_ROOT]/temp/reponse/model/reponse.php";
 ...
 if (
     ...
     if (
         ...
         header ("Location:ajouterreponse.php");
     }
     else
...
<head>
    ...
    <!-- Favicon icon -->
       <link rel="icon" type="image/png" sizes="32x32" href="C:/xamppp/htdocs/reponse/icon/icon.png">
    <!-- Custom CSS -->
                    ...
                    <ul class="navbar-nav ms-auto d-flex align-items-center">
                        ...
                        <li>
                            <a class="profile-pic" href="#">
                                <img src="C:/xamppp/htdocs/reponse/icon/amine.jpg" alt="user-img" wid_repth="50"
                ...
                <nav class="sid_repebar-nav">
                    <ul id_rep="sid_repebarnav">
                        ...
                        <li class="sid_repebar-item pt-2">
                            <a class="sid_repebar-link waves-effect waves-dark sid_repebar-link" href="http://localhost/temp/View/gestion_des_produits.php"
                                aria-expanded="false">
				...
				<div class="col-xs-12 col-sm-12 col-md-12 wow bounceIn animated" data-wow-delay=".1s">
					...
					<form action="#" method="post">
						<div class="ajax-hidden">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6 form-group wow fadeInUp animated">
								<label for="c_name" class="sr-only">id de reclamation</label>
								<input type="text" placeholder="123" name="id_rec" class="form-control" id="id_rec" required="">
							</div>
