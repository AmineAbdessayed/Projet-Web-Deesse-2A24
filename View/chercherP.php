...
<body>
  ...
  <path fill-rule="evenodd" d="M7.293 1.5a1 1 0 0 1 1.414 0l6.647 6.646a.5.5 0 0 1-.708.708L8 2.207 1.354 8.854a.5.5 0 1 1-.708-.708L7.293 1.5z"/>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="afficherParticips.php"
                                aria-expanded="false">
            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Gestion des Particips</h4>
                    </div>
  ...
  <div class="container">
<button  type ="submit" class="btn btn-primary my-5"><a href="afficherP.php"  class="text-light"> Ajouter</a> </button>
 <!-- =======================PHP======================================= -->
 <?php
include_once "$_SERVER[DOCUMENT_ROOT]/projet/Controller/ParticipsC.php";
if(isset($_POST['chercher'])){
$Particips=new ParticipsC();
$listeParticips=$Particips->chercherP($_POST["id_p"]);
...
'
;
foreach($listeParticips as $Particips){

echo '
<tr>
<td>'.$Particips['id_p'].' </td>
<td>'.$Particips['Nom_p'].' </td>
<td>'.$Particips['Prenom'].' </td>
<td>'.$Particips['adresse_mail'].' </td>
<td> '.$Particips['id_event'].' </td>

<td>

<button class="btn btn-info"><a href="modifierP.php? deletevar='.$Particips['id_p'].'" class="text-light">Modifier</a></button>
  <button class="btn btn-danger"><a href="supprimerP.php? deletevar='.$Particips['id_p'].'" class="text-light">Delete</a></button>
