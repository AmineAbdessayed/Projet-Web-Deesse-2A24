						  ...
						  foreach($listeC as $panier){
							...
							<tr>
								...
								<td class="product-des" data-title="Description">
									<p class="product-name"><a href="#">Ref produit : <?php echo $panier['refProduit']; ?></a></p>
								...
								<tr> <td><form action="panier.php" method="POST"><input class="btn" type="hidden" name="passer" ><input class="btn" type="submit" value="Passer commande"> </td></tr><form>
