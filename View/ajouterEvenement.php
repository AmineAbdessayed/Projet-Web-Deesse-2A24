...
<body>
                    ...
                    <ul class="navbar-nav ms-auto d-flex align-items-center">
                        ...
                        <li>
                            <a class="profile-pic" href="#">
                                <img src="C:/xampp/htdocs/projet/icon/amine.jpg" alt="user-img" width="50"
                                    class="img-circle"><span class="text-white font-medium">Amine</span></a>
                        </li>
                        <!-- ============================================================== -->
                        <!-- User profile and search -->
                        <!-- ============================================================== -->
  ...
  <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="http://localhost/temp/View/afficherP.php"
                                aria-expanded="false">
                                <i class="fa fa-table" aria-hidden="true"></i>
                                <span class="hide-menu">Gestion des participations</span>
                            </a>
                        </li>
...
<label for="examppleInputPassword1" class="">id:</label >
  ...
  <div class="">
    <label for="examppleInputPassword1" class="">date_debut:</label>
    <input type="date"  name="date_debut" class="form-control" id="cdate">
    <span id="cdate" style="color:#FF0000"> </span>
  </div>
    <div class="">
    <label for="examppleInputPassword1" class="">date_fin:</label>
    <input type="date"  name="date_fin" class="form-control" id="">
  </div>
  <div class="">
    <label for="examppleInputPassword1" class="">descriptions:</label>
    <input type="text"  name="descriptions" class="form-control" id="">
  </div>
  <div class="">
    <label for="examppleInputPassword1" class="">Adresse:</label>
