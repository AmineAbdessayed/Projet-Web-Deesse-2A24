<?php
 ...
 if (isset($_REQUEST['TriASC'])) {
	 $listeParticips=$Particips->triNomASC(); 
 } elseif (isset($_REQUEST['TriDESC'])) {
	 $listeParticips=$Particips->triNomDESC(); 
 } else {
...
<body>
 ...
 <a href="file:///C:/xampp/htdocs/projet/frontend/frontend/index.html" target="_blank"
 ...
 <div class="container">
<button type ="submit" class="btn btn-primary my-5"><a href="ajouterP.php" class="text-light"> Ajouter un Particips</a> </button>
 ...
 <div class="input-group">
  ...
  <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z"/>
      ...
      <input type="text" class="form-control" name="id_p" placeholder="Chercher par...">
